...
export interface RoutingRule {
   ...
   */
  routing_parameters?: RoutingParameter[] | undefined;
...
export const RoutingRule = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 2:
          ...
          message.routing_parameters!.push(RoutingParameter.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): RoutingRule {
    return {
      routing_parameters: Array.isArray(object?.routing_parameters)
        ? object.routing_parameters.map((e: any) => RoutingParameter.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: RoutingRule): unknown {
    ...
    if (message.routing_parameters?.length) {
      obj.routing_parameters = message.routing_parameters.map((e) => RoutingParameter.toJSON(e));
    }
    return obj;
  },
};
...
export const routing: Extension<RoutingRule> = {
  number: 72295729,
  tag: 578365834,
  repeated: false,
  packed: false,
  encode: (value: RoutingRule): Uint8Array[] => {
    const encoded: Uint8Array[] = [];
    const writer = _m0.Writer.create();
    RoutingRule.encode(value, writer.fork()).ldelim();
    encoded.push(writer.finish());
    return encoded;
  },
  decode: (tag: number, input: Uint8Array[]): RoutingRule => {
    const reader = _m0.Reader.create(input[input.length - 1] ?? fail());
    return RoutingRule.decode(reader, reader.uint32());
  },
};
